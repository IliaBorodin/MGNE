...
using MGNE.Commands.CanvasCommands;
...
namespace MGNE.ViewModels
{
    public class NetworkConfigurationViewModel : ViewModelBase
    {
        ...
        {
            CreateNetworkCommand = new NavigateCommand<NetworkDynamicsViewModel>(networkDinamicsNavigationService, this);
            ...
            _scaleTransform.ScaleX = _currentCanvasScale;
            _scaleTransform.ScaleY = _currentCanvasScale;
        ...
        private double _currentCanvasScale = 1.0;
        public double CurrentCanvasScale
        {
            get { return _currentCanvasScale; }
            set
            {
                _currentCanvasScale = value;
                OnPropertyChanged(nameof(CurrentCanvasScale));
            }
        }
        ...
        public ScaleTransform ScaleTransform
        {
            ...
            set
            {
                ...
                OnPropertyChanged(nameof(ScaleTransform));
            }
        }
